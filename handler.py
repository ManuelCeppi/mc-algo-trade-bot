...
def algo_trade_long_strategy_function(stock):
    ...
    if(is_neutral_from_oversold):
        ...
        is_bullish_candle = market_utility.check_if_stock_is_bullish_candle(global_quote['high'], stock_price_candle_data)
        ...
        if(is_bullish_candle):
            ...
            higher_volumes = market_utility.check_if_stock_volume_is_higher_than_previous_candle(global_quote['volume'], stock_price_candle_data)
...
def algo_trade_short_strategy_function(stock):
    ...
    if(is_neutral_from_overbought):
        ...
        global_quote = __data_client.get_stock_otc_quote(stock.symbol)
        stock_price_candle_data = __data_client.get_stock_intraday_data(stock.symbol)
        is_bearish_candle = market_utility.check_if_stock_is_bearish_candle(global_quote['low'],stock_price_candle_data)
